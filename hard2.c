  ...
  <body>
    ...
    <div class="container" id="root" data-lang="c">
      ...
      <div class="wrapper">
        <a
          id="sale-top-banner"
          class="sale-top-banner d-none"
          rel="nofollow"
          href="https://programiz.pro/offer/cyber-monday?utm_source=banner-compiler&utm_medium=banner&utm_campaign=cybermonday-sale__banner-compiler__nov__60"
          title="Claim Discount"
          target="_blank"
        >
          <div class="sale-top-banner__wrapper">
            <!-- Left wrapper -->
            ...
            <div class="sale-top-banner__wrapper__center">
              <div class="sale-top-banner__title">60% off on Lifetime Deal! Pay once for skills that pay forever.</div>
              <span class="sale-top-banner__cta">Claim Discount</span>
            </div>
            <!-- Right wrapper -->
            <div class="sale-top-banner__wrapper__right">
              <div class="sale-top-banner__title">
                Sale ends in <span id="sale-time-countdown" class="sale-top-banner__sale-timer"></span>
              </div>
            </div>
          </div>
        </a>
        ...
        <div class="editor-wrapper">
          <div class="editor-desktop-top-bar">
            ...
            <div class="desktop-top-bar__btn-wrapper">
              ...
              <button class="desktop-save-button" style="display: block">
                <span>
                  &nbsp;Save&nbsp;
                </span>
              </button>
